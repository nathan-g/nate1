...
API_EXPORT(ap_mutex *) ap_create_mutex(char *name);
API_EXPORT(ap_mutex *) ap_open_mutex(char *name);
API_EXPORT(int) ap_acquire_mutex(ap_mutex *mutex_id);
API_EXPORT(int) ap_release_mutex(ap_mutex *mutex_id);
API_EXPORT(void) ap_destroy_mutex(ap_mutex *mutex_id);
...
#define ap_create_mutex(name)	((ap_mutex *)ap_dummy_mutex)
